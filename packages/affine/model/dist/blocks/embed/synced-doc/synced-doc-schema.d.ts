...
export declare const EmbedSyncedDocBlockSchema: {
    version: number;
    model: {
        props: import("@lumensuite/store").PropsGetter<import("../../../utils/helper.js").EmbedProps<EmbedSyncedDocBlockProps>>;
    ...
    transformer?: (() => import("@lumensuite/store").BaseBlockTransformer<import("../../../utils/helper.js").EmbedProps<EmbedSyncedDocBlockProps>>) | undefined;
};
