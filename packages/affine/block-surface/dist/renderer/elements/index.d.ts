...
export type ElementRenderer<T extends LumenSuite.SurfaceElementModel = SurfaceElementModel> = (model: T, ctx: CanvasRenderingContext2D, matrix: DOMMatrix, renderer: CanvasRenderer, rc: RoughCanvas, viewportBound: IBound) => void;
