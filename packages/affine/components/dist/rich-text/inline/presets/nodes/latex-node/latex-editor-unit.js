...
import { ZERO_WIDTH_SPACE } from '@lumensuite/inline';
import { html } from 'lit';
import { customElement, property } from 'lit/decorators.js';
import { styleMap } from 'lit/directives/style-map.js';
let LatexEditorUnit = (() => {
    let _classDecorators = [customElement('latex-editor-unit')];
    ...
    var LatexEditorUnit = class extends _classSuper {
        ...
        static {
            ...
            LatexEditorUnit = _classThis = _classDescriptor.value;
    ...
    return LatexEditorUnit = _classThis;
})();
