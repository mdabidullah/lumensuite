import type { BlockComponent, BlockStdScope, DisposableClass } from '@blocksuite/block-std';
...
export interface PeekViewService {
     ...
     * @returns A promise that resolves when the peek view is closed.
     */
    peek<Element extends BlockComponent>(target: Element, template?: TemplateResult): Promise<void>;
}
