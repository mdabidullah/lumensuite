...
export type GetColumnDataFromConfig<T> = T extends ColumnConfig<infer R, any> ? R : never;
export type GetCellDataFromConfig<T> = T extends ColumnConfig<any, infer R> ? R : never;
export type ColumnConfig<Data extends NonNullable<unknown> = NonNullable<unknown>, Value = unknown> = {
    name: string;
    defaultData: () => Data;
