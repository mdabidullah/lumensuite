...
import { defineBlockSchema, internalPrimitives, Schema, } from '../schema/index.js';
...
test('on change', () => {
    ...
    expect(onPropsUpdated).toHaveBeenCalledWith(expect.anything(), 'title', expect.anything());
    ...
    expect(onPropsUpdated).toHaveBeenCalledWith(expect.anything(), 'boxed', expect.anything());
