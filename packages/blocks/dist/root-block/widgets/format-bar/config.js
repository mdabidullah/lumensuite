                ...
                action: c => {
                    ...
                    c.std.command
                        ...
                        ctx.draftedModels
                            ...
                            return ctx.std.clipboard.duplicateSlice(slice, ctx.std.doc, ctx.parentBlock?.model.id, ctx.blockIndex ? ctx.blockIndex + 1 : undefined);
                        })
                            .catch(console.error);
                        return next();
                    })
...
export function toolbarMoreButton(toolbar) {
