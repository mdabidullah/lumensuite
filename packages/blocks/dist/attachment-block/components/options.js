...
export function AttachmentOptionsTemplate({ anchor, model, abortController, }) {
    ...
    const groups = getMoreMenuConfig(anchor.std).configure(cloneGroups(BUILT_IN_GROUPS));
    ...
    const buttons = [
      ...
      >
        <div data-size="small" data-orientation="vertical">
          ${repeat(viewActions, button => button.type, ({ type, label, action }) => html `
              <editor-menu-action
