...
let AttachmentEdgelessBlockComponent = (() => {
    let _classDecorators = [customElement('affine-edgeless-attachment')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = toGfxBlockComponent(AttachmentBlockComponent);
    var AttachmentEdgelessBlockComponent = class extends _classSuper {
        ...
        static {
            ...
            AttachmentEdgelessBlockComponent = _classThis = _classDescriptor.value;
    ...
    return AttachmentEdgelessBlockComponent = _classThis;
})();
export { AttachmentEdgelessBlockComponent };
