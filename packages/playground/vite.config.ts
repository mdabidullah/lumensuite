...
export function sourcemapExclude(): Plugin {
  return {
    ...
    transform(code: string, id: string) {
      if (id.includes('node_modules') && !id.includes('@lumensuite')) {
        return {
          code,
...
const chunkGroups = {
  framework: [
    require.resolve('@lumensuite/block-std'),
    require.resolve('@lumensuite/block-std/gfx'),
    require.resolve('@lumensuite/global'),
    require.resolve('@lumensuite/global/utils'),
    require.resolve('@lumensuite/global/env'),
    require.resolve('@lumensuite/global/exceptions'),
    require.resolve('@lumensuite/global/di'),
    require.resolve('@lumensuite/inline'),
    require.resolve('@lumensuite/store'),
    require.resolve('@lumensuite/sync'),
  ],
  components: [
    require.resolve('@lumensuite/affine-components/icons'),
    require.resolve('@lumensuite/affine-components/peek'),
    require.resolve('@lumensuite/affine-components/portal'),
    require.resolve('@lumensuite/affine-components/hover'),
    require.resolve('@lumensuite/affine-components/toolbar'),
    require.resolve('@lumensuite/affine-components/toast'),
    require.resolve('@lumensuite/affine-components/rich-text'),
    require.resolve('@lumensuite/affine-components/caption'),
    require.resolve('@lumensuite/affine-components/context-menu'),
    require.resolve('@lumensuite/affine-components/date-picker'),
  ],
  affine: [
    require.resolve('@lumensuite/affine-shared'),
    require.resolve('@lumensuite/affine-model'),
    require.resolve('@lumensuite/affine-block-list'),
    require.resolve('@lumensuite/affine-block-paragraph'),
    require.resolve('@lumensuite/affine-block-surface'),
    require.resolve('@lumensuite/data-view'),
  ],
  ...
  blocks: [
    require.resolve('@lumensuite/blocks'),
    require.resolve('@lumensuite/blocks/schemas'),
  ],
  presets: [require.resolve('@lumensuite/presets')],
  common: [
